...
- What is the probability a randomly selected patient received the placebo
  and the treatment?
0 *disjoint probability - not possible at same time
...
Blue probability = 3/8
White probability = 1/8
...
experiment. 'replace = FALSE' is default.
...
As we increase size/number of samples drawn, we get closer and closer to 
"true" probability (Law of Large Numbers).
